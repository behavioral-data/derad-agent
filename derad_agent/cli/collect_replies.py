...
from derad_agent.app.events import BotReplyReply, get_store, log_reply_reply, utcnow
...
def _in_window(posted_at: datetime | None, now: datetime) -> bool:
...
def _collect_one(
    ...
    for tweet in data:
        ...
        # Only keep direct replies to our bot reply
