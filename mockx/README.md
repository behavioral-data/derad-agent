...
- Bot replies are generated by `scripts/batch_generate_replies.py` and committed to
  `tsv_generation/selected_posts_replies.csv`; `build_db` ingests them automatically. A post
